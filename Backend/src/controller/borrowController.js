...
class borrowController {
    ...
    static async seeAllBorrow(req, res) {
        try {
            ...
            const response = {
                status: 200,
                message: 'Menampilkan Data Peminjaman Sukses',
                data: borrows,
                time: timer
            }
    ...
    static async seeBorrow(req, res) {
        try {
            ...
            const response = {
                status: 200,
                message: 'Menampilkan Peminjaman Sukses',
                data: borrows,
                time: timer
            }
            return res.status(200).send(response)
    ...
    static async acceptBorrow(req, res) {
        try {
            ...
            if (data.status == 'SUKSES' || data.status == 'DITOLAK') throw new Error('Data tidak dapat diubah')
            ...
            const response = {
                status: 200,
                message: 'Berhasil Menerima Peminjaman',
                data: borrow,
                time: timer
            }
            return res.status(200).send(response)
