import { CLEAR_ACCOUNT_MESSAGE, DELETE_ACCOUNT, DELETE_ACCOUNT_FAILED, DELETE_ACCOUNT_SUCCESS, EDIT_ACCOUNT, EDIT_ACCOUNT_FAILED, EDIT_ACCOUNT_SUCCESS, GET_ACCOUNT, GET_ACCOUNT_SUCCESS, POST_ACCOUNT_ADMIN, POST_ACCOUNT_ADMIN_FAILED, POST_ACCOUNT_ADMIN_SUCCESS, POST_ACCOUNT_SUPER, POST_ACCOUNT_SUPER_FAILED, POST_ACCOUNT_SUPER_SUCCESS, POST_BLOCK, POST_BLOCK_FAILED, POST_BLOCK_SUCCESS, POST_UNBLOCK, POST_UNBLOCK_FAILED, POST_UNBLOCK_SUCCESS } from "./actionTypes";
...
export const deleteAccountFailed = (message) => ({
